...
<SOAP-ENV:Body> \
<traynotifierservice:ShowNotification><CallbackEndpoint>http://localhost:11000/clientagent</CallbackEndpoint><IconHandle>1</IconHandle><NotifyMessage>Job "{JobDisplayName}" wird ausgef&#252;hrt...</NotifyMessage><b64Data>Tm90ZXBhZCsr</b64Data><nNotifyIcon>1</nNotifyIcon></traynotifierservice:ShowNotification>\
</SOAP-ENV:Body> \
</SOAP-ENV:Envelope>'
